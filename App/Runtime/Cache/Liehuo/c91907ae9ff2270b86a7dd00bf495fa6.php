        ...
        <div class="widget-content nopadding">
          <div class="table-responsive">
            <table class="table table-bordered text-center">
              ...
              <tbody>
<?php $form = 'form_auth_rule_add'; ?>
                <tr class="gradeX">
                  <td>添加</td>
                  <td>
                    <input type="number" name="sort" value="" placeholder="选填" form="<?php echo ($form); ?>" class="form-control input-sm">
                  </td>
                  <td>
                    <input type="text" name="name" value="" placeholder="唯一不可重复" form="<?php echo ($form); ?>" class="form-control input-sm">
                  </td>
                  <td>
                    <input type="text" name="title" value="" placeholder="选填" form="<?php echo ($form); ?>" class="form-control input-sm">
                  </td>
                  <!--td>
                    <input type="text" name="condition" value="<?php echo ($v['condition']); ?>" form="<?php echo ($form); ?>" class="form-control input-sm">
                  </td-->
                  <td>
                    <input type="text" name="group_name" value="<?php echo ($v['group_name']); ?>" form="<?php echo ($form); ?>" placeholder="选填，权限分组" class="form-control input-sm">
                  </td>
                  <td>
                    <form action="<?php echo U('auth_rule_save');?>" method="POST" id="<?php echo ($form); ?>" class="form-inline">
                      <input type="hidden" name="id" value="">
                      <button type="submit" class="btn btn-primary">添加</button>
                    </form>
                  </td>
                </tr>
<?php if(is_array($data['list'])): $i = 0; $__LIST__ = $data['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i; $form = 'form_auth_rule_'.$v['id']; ?>
                <tr class="gradeX">
                  <td><?php echo ($v['id']); ?></td>
                  <td>
                    <input type="number" name="sort" value="<?php echo ($v['sort']); ?>" placeholder="选填" form="<?php echo ($form); ?>" class="form-control input-sm">
                  </td>
                  <td>
                    <input type="text" name="name" value="<?php echo ($v['name']); ?>" form="<?php echo ($form); ?>" class="form-control input-sm">
                  </td>
                  <td>
                    <input type="text" name="title" value="<?php echo ($v['title']); ?>" form="<?php echo ($form); ?>" class="form-control input-sm">
                  </td>
                  <!--td>
                    <input type="text" name="condition" value="<?php echo ($v['condition']); ?>" form="<?php echo ($form); ?>" class="form-control input-sm">
                  </td-->
                  ...
                  <td>
                    ...
                    <a href="<?php echo U('auth_rule_del?id='.$v['id']);?>" class="btn btn-danger" onclick="return confirm('确定这么做？')">删除</a>
                  </td>
